...
@@ -57,3 +58,46 @@ console.log("Pelle" + " " + "Nordström");   // "Pelle Nordström"
...
console.log("The last dot exist at index: " + email.lastIndexOf("."));

console.log(
  " The top domain for email is: " + email.slice(email.lastIndexOf("."))
);
